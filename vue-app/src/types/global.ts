...
export interface SpeechRecognitionCallbacks {
  onResult: (newFinalWords: string[], speechOutputHTML: string) => Promise<void>
...
export const LOG_LEVELS: readonly LogLevel[] = ['off', 'error', 'info', 'debug'] as const

export const BUTTON_VARIANTS = ['primary', 'secondary', 'success', 'danger', 'neutral'] as const
export const BUTTON_SIZES = ['small', 'medium', 'large'] as const
export const INPUT_TYPES = ['text', 'number', 'email', 'password', 'search'] as const
